...
export const BorderLoadingIndicator = ({
  ...
  return (
    <>
      <div className="absolute -left-[2px] -top-[2px] h-[calc(100%+3.5px)] w-[calc(100%+3.5px)]">
        <style>
          {`
        @keyframes spin {
...
const StatusBorder = ({
  ...
  return (
    <>
      <div
        className={cn(
          "absolute -left-[2px] -top-[2px] h-[calc(100%+3.5px)] w-[calc(100%+3.5px)] rounded-md border-4",
          className
        )}
      />
      {children}
